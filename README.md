...
pip install pyephem
~~~
One should also install [rtl-sdr drivers for windows](https://ftp.osmocom.org/binaries/windows/rtl-sdr/). Then the "x64" folder has to be added to PATH under system variables. This will require a system restart.
